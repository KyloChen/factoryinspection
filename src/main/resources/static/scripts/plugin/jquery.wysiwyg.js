...
(function( $ )
{
    ...
    $.extend(Wysiwyg, {
        ...
        TOOLBAR : {
            ...
            h1mozilla : { visible : true && (navigator.userAgent.indexOf('Firefox') != -1), className : 'h1', command : 'heading', arguments : ['h1'], tags : ['h1'] },
            h2mozilla : { visible : true && (navigator.userAgent.indexOf('Firefox') != -1), className : 'h2', command : 'heading', arguments : ['h2'], tags : ['h2'] },
            h3mozilla : { visible : true && (navigator.userAgent.indexOf('Firefox') != -1), className : 'h3', command : 'heading', arguments : ['h3'], tags : ['h3'] },

            h1 : { visible : true && (navigator.userAgent.indexOf('Firefox') == -1), className : 'h1', command : 'formatBlock', arguments : ['Heading 1'], tags : ['h1'] },
            h2 : { visible : true && (navigator.userAgent.indexOf('Firefox') == -1), className : 'h2', command : 'formatBlock', arguments : ['Heading 2'], tags : ['h2'] },
            h3 : { visible : true && (navigator.userAgent.indexOf('Firefox') == -1), className : 'h3', command : 'formatBlock', arguments : ['Heading 3'], tags : ['h3'] },
            ...
            separator08 : { separator : true && !( navigator.userAgent.indexOf("MSIE") > 0 ) },

            increaseFontSize : { visible : true && !( navigator.userAgent.indexOf("MSIE") > 0 ), tags : ['big'] },
            decreaseFontSize : { visible : true && !( navigator.userAgent.indexOf("MSIE") > 0 ), tags : ['small'] },
    ...
    $.extend(Wysiwyg.prototype,
    {
        ...
        initFrame : function()
        {
            ...
            {
                if ( navigator.userAgent.indexOf("MSIE") > 0 && self.options.brIE && event.keyCode == 13 )
                {
